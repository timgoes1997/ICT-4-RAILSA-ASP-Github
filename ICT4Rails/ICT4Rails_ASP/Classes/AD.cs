...
namespace ICT4Rails.Scripts
{
    public class ADMethodsAccountManagement
    {
        ...
        #region Variables
        //Kijk hier nog naar
        private string sDomain = "ICT4Rails.local";
        private string sDefaultOU = "DC=INFRA-S78,DC=local";
        private string sDefaultRootOU = "DC=INFRA-S78,DC=local";
        private string sServiceUser = "CN=Administrator,CN=Users,DC=INFRA-S78,DC=local";
        private string sServicePassword = "P@ssword1";
